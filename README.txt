...
-code for our general simulations (i.e., not specific to Vulpia) can be found in "code for ms - main simulations - all figs"

-code specific to the Vulpia analyses can be found in "vulpia fitting"

-"summary of simulatiomn" contains the summary outputs from a run of the "vulpia fitting" code
